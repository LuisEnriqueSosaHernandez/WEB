...
<input type="reset" value="Limpiar Datos" name="btnReset">
	...
	<h2 id="sec02">Herramientas de desarrollo</h2>
	<a href="#sec01">Seccion 01</a>
	<a href="#sec03">Seccion 03</a>
	<h2 id="#sec02">Seccion 02</h2>
	...
	<p>Android Studio es el entorno de desarrollo integrado oficial para la plataforma Android. Fue anunciado el 16 de mayo de 2013 en la conferencia Google I/O, y reemplazó a Eclipse como el IDE oficial para el desarrollo de aplicaciones para Android. La primera versión estable fue publicada en diciembre de 2014.
		...
		<h4 id="sec03">Mit App Inventor</h4>
		<a href="#sec01">Seccion 01</a>
		<a href="#sec02">Seccion 02</a>
		<h2 id="#sec03">Seccion 03</h2>
		<p>App Inventor es un entorno de desarrollo de software creado por Google Labs para la elaboración de aplicaciones destinadas al sistema operativo Android. El usuario puede, de forma visual y a partir de un conjunto de herramientas básicas, ir enlazando una serie de bloques para crear la aplicación. El sistema es gratuito y se puede descargar fácilmente de la web. Las aplicaciones creadas con App Inventor están limitadas por su simplicidad, aunque permiten cubrir un gran número de necesidades básicas en un dispositivo móvil.
			...
			<ul>
				<li type="circle">Elemento1</li>
				<li type="square">Elemento2</li>
				<li type="disc">Elemento3</li>
			</ul>
			<ol >
				<li type="A">Elemento1</li>
				<li type="a">Elemento2</li>
				<li type="I">Elemento3</li>
				<li type="i">Elemento4</li>
				<li type="start">Elemento5</li>
			</ol>
			<a href="#sec01"><img src="img/android.png"></a>
